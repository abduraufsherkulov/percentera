...
export class CreditsInCard extends Component {
  constructor(props) {
    super(props);
    this.state = {};
  }
  ...
  render() {
    ...
    let viewButton =
      ...
      userStatus === null ? (
        ...
        <Button
          color="yellow"
          to={`/creditsin/${borrow_id}/creditsinstat/${id}`}
          tag={Link}
        >
          View
        </Button>
    ...
    if (status === "waiting_approve") {
      main_status = "Waiting for your response";
    } else if (status === "accepted") {
      main_status = "You accepted this offer";
    } else if (status === "declined") {
      main_status = "You declined this offer";
    } else if (status === "paid") {
      main_status = "You have already paid back";
    }

    let showButton;
    if (status === "waiting_approve") {
      showButton = activeButtons;
    } else if (status === "accepted") {
